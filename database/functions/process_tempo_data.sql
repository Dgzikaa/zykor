...
BEGIN
    FOR item_json IN SELECT jsonb_array_elements(p_data_array) LOOP
        ...
        INSERT INTO contahub_tempo (
            ...
            ano, mes, dia, dds, diadasemana, hora, itm_qtd, data, categoria
        ) VALUES (
            p_bar_id,
            ...
            p_data_date,
            COALESCE(item_json->>'categoria', '')
        );
        inserted_count := inserted_count + 1;
    END LOOP;
    
    -- Popula tabela de dominio tempos_producao
    PERFORM adapter_contahub_to_tempos_producao(p_bar_id, p_data_date);
