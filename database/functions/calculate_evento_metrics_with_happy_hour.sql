...
DECLARE
    ...
    calculated_percent_happy_hour NUMERIC;
BEGIN
    ...
    -- =================================================
    -- 5. BUSCAR DADOS CONTAHUB ANALÍTICO (COM HAPPY HOUR)
    -- =================================================
    SELECT 
        ...
        SUM(CASE WHEN grp_desc = 'Happy Hour' THEN valorfinal ELSE 0 END) as valor_happy_hour,
    ...
    RAISE NOTICE 'Métricas calculadas para evento %: Real=% | Clientes=% | TE=% | TB=% | T.Médio=% | Reservas=%/% | HappyHour=%', 
        evento_id, calculated_real_r, calculated_cl_real, calculated_te_real, calculated_tb_real, calculated_t_medio, calculated_res_p, calculated_res_tot, calculated_percent_happy_hour;
