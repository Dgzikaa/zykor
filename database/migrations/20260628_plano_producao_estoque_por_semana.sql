-- fn_plano_producao: estoque preso à contagem do INÍCIO da semana planejada.
-- Aplicada em prod via MCP em 2026-06-28 (migration plano_producao_estoque_por_semana).
-- Planejar 29/06–05/07 usa necessariamente a contagem >= 29/06; sem ela, estoque = 0
-- (a tela aguarda a contagem). Novo parâmetro p_estoque_desde (default null = sem filtro).
