-- 2026-06-14 — Fix CMV mensal: bonificações SOMAM (alinhar ao semanal).
-- Bug (reportado pelo sócio): agregar_cmv_mensal_auto SUBTRAÍA as bonificações, enquanto
-- o trigger semanal SOMA. Resultado: CMV R$ mensal vinha baixo em 2× bonif.
-- Caso real Bar 3 / maio/2026: exibia 289.340,67; correto = 352.125,28.
--
-- Passa a usar o campo unificado `bonificacoes` (ver 20260614_cmv_bonificacoes_unificada.sql),
-- com fallback p/ os legados. Demais regras (estoque/compras/consumos) inalteradas aqui.
...
BEGIN
  ...
  -- FIX 2026-06-14: bonificações SOMAM (igual ao semanal). Antes subtraía.
