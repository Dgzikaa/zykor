// [FUNÇÃO ATIVA - USO MODERADO] Monitora eventos de concorrentes em Brasília
// Uso confirmado em:
// - frontend/src/app/api/concorrencia/monitorar/route.ts
// - Pode ser chamada manualmente ou via cron para monitoramento periódico
