...
import { Loader2, Save, RefreshCw, Calculator, Users, Plus, Trash2, Lock, Unlock, AlertTriangle } from 'lucide-react';
...
export default function CMOSimulador() {
  ...
  return (
    <div className="space-y-6">
      ...
      {dados.simulacao_salva && (
        <div className="flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/20 rounded-lg border-2 border-green-500 w-fit">
