...
const ROWS: RowDef[] = [
  ...
  { id: 'pc_adm_mkt', label: 'Adm & Mkt', tipo: 'ca', indent: true, formula: 'Marketing + Administrativo Ordinário + Escritório Central (em aberto)' },
  { id: 'pc_operacionais', label: 'Despesas Operacionais', tipo: 'ca', indent: true, formula: 'Materiais Operação + Materiais de Limpeza e Descartáveis + Utensílios + Outros Operação + (sem categoria) — em aberto' },
  { id: 'pc_ocupacao', label: 'Ocupação', tipo: 'ca', indent: true, formula: 'Luz + Água + Internet + Aluguel/Condomínio/IPTU + Manutenção (em aberto)' },
  { id: 'pc_cmo_comissao', label: 'CMO + Comissão', tipo: 'ca', indent: true, formula: 'Salário Func + Vale Transporte + Adicionais + Pró-labore + Freelas (Atend/Bar/Cozinha/Limpeza/Segurança) + Comissão 10% (em aberto)' },
