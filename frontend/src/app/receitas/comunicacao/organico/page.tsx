...
/**
 * Comunicação › Orgânico (área Receitas) — SÓ Instagram ORGÂNICO.
 *
 ...
 * - Mídia PAGA (Meta Ads) e ROAS vivem na aba "Mídia" (separação orgânico × investido).
 */
...
export default function ComunicacaoOrganicoPage() {
  ...
  useEffect(() => {
    setPageTitle('📣 Comunicação — Orgânico');
    return () => setPageTitle('');
  }, [setPageTitle]);
    ...
    <PageShell width="wide">
      <div className="flex flex-col gap-2">
        <p className="text-sm text-[hsl(var(--muted-foreground))]">
          Instagram orgânico de {selectedBar?.nome ?? 'o bar selecionado'}. Mídia paga na aba <strong>Mídia</strong>.
        </p>
