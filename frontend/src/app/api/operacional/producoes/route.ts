...
// rota usada pela tela de Fichas (e cadastro de produção); libera se puder na Fichas OU Produção
const PATHS = ['/operacional/fichas-tecnicas', '/operacional/producoes'];
