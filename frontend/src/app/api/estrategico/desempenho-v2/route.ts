  ...
  try {
    ...
    const semanasProcessadas = (semanasGold || []).map((semana: any) => {
      ...
      return {
        ...
        cmv_global_real: (semana.cmv && semana.faturamento_total) ? (semana.cmv / semana.faturamento_total * 100) : 0,
        ...
        cmo_percentual: (semana.cmo && semana.faturamento_total) ? (semana.cmo / semana.faturamento_total * 100) : 0,
        ...
        nota_felicidade_equipe: semana.nota_felicidade_equipe || manual.nota_felicidade_equipe || 0,
