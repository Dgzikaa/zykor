...
export async function POST(request: NextRequest) {
  try {
    ...
    // Chamar Edge Function de auditoria. Autoriza com a service role (padrão do projeto p/
    // chamada servidor→edge): não existe mais um access_token de sessão Supabase aqui.
