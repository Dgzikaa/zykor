...
export default function CMOAlertasPage() {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Notificações quando CMO ultrapassar a meta
          </p>
        </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <div className="flex gap-2">
                      <Link
                        href={`/ferramentas/cmo-semanal?ano=${alerta.cmo_semanal.ano}&semana=${alerta.cmo_semanal.semana}`}
                      >
